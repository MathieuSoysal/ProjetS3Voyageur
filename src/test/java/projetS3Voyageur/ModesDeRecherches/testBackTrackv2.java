...
public class testBackTrackv2 {
    private ModeRecherche algo = new BackTrackV2();
    private ModeRecherche brutForce = new BrutForceV4();

    // #region Ajout test Comparaison BrutForceV4

    // #region test avec les résultat issue de BrutForce v2
    @Test
    public void test_4villes_comparaisons_brutForceV4() throws NumVilleException {
    ...
    @Test
    public void test_5villes_comparaisons_brutForceV4() throws NumVilleException {
    ...
    @Test
    public void test_6villes_comparaisons_brutForceV4() throws NumVilleException {
    ...
    @Test
    public void test_7villes_comparaisons_brutForceV4() throws NumVilleException {
    ...
    @Test
    public void test_8villes_comparaisons_brutForceV4() throws NumVilleException {
    ...
    @Test
    public void test_9villes_comparaisons_brutForceV4() throws NumVilleException {
    ...
    @Test
    public void test_10villes_comparaisons_brutForceV4() throws NumVilleException {
    ...
    @Test
    public void test_11villes_comparaisons_brutForceV4() throws NumVilleException {
    ...
    @Test
    public void test_comparaisont_10villes_avecBrutForceV4_ville_depart_3() {
        for (int i = 0; i < 10; i++) {
            Pays pays = new Pays(10);
            ...
            assertEquals(brutForce.getParcours().getDistance(), algo.getParcours().getDistance());
            assertEquals(algo.getParcours().getDistance(),
                    parcoursVilles(pays, algo.getParcours().getVillesEmprunté(), ">"));
        }
    }
    ...
    @Test
    public void test_comparaisont_9villes_avecBrutForceV4_villeDepart2() {
        for (int i = 0; i < 15; i++) {
            Pays pays = new Pays(9);
    ...
    @Test
    public void test_comparaisont_10villes_avecBrutForceV4() {
        for (int i = 0; i < 10; i++) {
            Pays pays = new Pays(10);
    ...
    @Test
    public void test_comparaisont_9villes_avecBrutForceV4() {
        for (int i = 0; i < 15; i++) {
            Pays pays = new Pays(9);
    ...
    @Test
    public void test_comparaisont_8villes_avecBrutForceV4() {
        for (int i = 0; i < 50; i++) {
            Pays pays = new Pays(8);
    ...
    // #endregion Ajout test COmparaison BrutForceV4
